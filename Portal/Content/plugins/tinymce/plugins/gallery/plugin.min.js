                    ...
                    if (obj.Items != null)
                    {
                        $.each(obj.Items, function (key, value) {
                            ...
                            items.push({
                                ...
                                onclick: function (e) {
                                    var bg_img = value.Preview ? value.Preview : no_photo;
                                    var style_cont = "width:100%;height:100px;background-color:#cdcdcd;background-image:url(" + bg_img + ");background-repeat:no-repeat;background-position:center;background-size:150px;)";
                                    var cl = "gallery";
                                    var gal = '<div class="' + cl + '" data-id="' + value.Id + '" style="' + style_cont + '"></div>';
                                    editor.insertContent(gal);
                            ...
                            items.push({
                                ...
                                + "<img src='" + (value.Preview ? value.Preview : no_photo) + "' title='" + value.Title + "'>"
                                        + "</div>"
