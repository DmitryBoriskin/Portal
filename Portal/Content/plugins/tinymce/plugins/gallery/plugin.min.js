                    ...
                    if (obj.Items != null)
                    {
                        $.each(obj.Items, function (key, value) {
                            ...
                            items.push({
                                ...
                                onclick: function (e) {
                                    var style_cont = "width:100%;height:100px;background-color:#cdcdcd;background-image:url(" + value.Preview + ");background-repeat:no-repeat;background-position:center;background-size:150px;)";
                                    var cl = "gallery";
