...
namespace AuthModule.Auth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var siteId = Guid.Parse("22814f6b-291e-4364-91f0-4b47a8f5f383");
            ...
            //---------------------------------------------------
            //Избавились от дополнительных проверок, записав в UserName(identity requires unique string) = Id(identity AspNet[Tables] links on) = UserId(portal requires Guid)
            //---------------------------------------------------
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (!UserManager.Users.Any(u => u.UserName == model.Email && u.SiteId == siteId))
                {
